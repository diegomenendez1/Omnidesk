...
export const translations: Translations = {
  en: {
    ...
    dashboard: {
      ...
      taskDistributionByStatus: "A quick look at how tasks are distributed by status.",
      projectSpotlight: "Project Spotlight",
      highlightingKeyProject: "Highlighting a key project currently in progress.",
    ...
    uploadData: {
      ...
      fileAcceptedToastDescription: "Please review column mappings.",
      columnMappingTitle: "Column Mapping",
      columnMappingDescription: "Review and adjust how columns from your CSV file ({fileName}) are mapped to system columns. 'TO Ref.' is crucial for matching.",
      csvColumn: "CSV Column",
      mapToSystemColumn: "Map to System Column",
      doNotImport: "Do not import this column",
      cancel: "Cancel",
      confirmAndProcess: "Confirm Mappings & Process Data",
      ...
      tasksProcessedAndSaved: "{count} total tasks after processing. Review preview.",
      ...
      fileUploader: {
        ...
        emptyFileToastDescription: "The header is empty or no data rows were found.",
        parseErrorToastTitle: "CSV Parse Error",
      ...
      backup: {
        ...
        backupAndContinueButton: "Backup & Continue",
      ...
      validationErrors: {
        ...
        description: "{count} CSV rows had validation errors or missing critical data (like TO Ref). Details for the first {firstN}:\n{details}",
      },
      noValidTasksProcessed: "No Valid Tasks Processed",
      allRowsInvalid: "All rows from the CSV file were invalid or could not be processed. Please review errors and try again.",
    ...
    dataValidationReport: {
      ...
      noInconsistenciesFoundDescription: "The AI analysis completed successfully and found no inconsistencies in the current dataset.",
      cell: "Cell",
    ...
    loginPage: {
      ...
      error: {
        ...
        requiresRecentLogin: "This operation is sensitive and requires recent authentication. Please sign in again.",
        passwordRequired: "Password is required.",
        networkError: "A network error occurred. Please check your connection and try again.",
        apiKeyInvalid: "The Firebase API key is not valid. Please check your Firebase project configuration.",
      }
    },
  },
  es: {
...
// This type needs to be defined *after* the `Translations` interface and the `translations` object
// and *before* it's used in `export type TranslationKey`.
type TranslationNamespaces = Translations['en']; // Define based on one locale, assuming structure is consistent
