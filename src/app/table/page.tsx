...
const initialTasks: Task[] = [
  ...
  { id: "TASK-002", name: "Design UX Mockups", status: "Missing POD", assignee: "Bob", taskReference: "T002", delayDays: 2, customerAccount: "Beta Inc", netAmount: 2500, transportMode: "Sea", comments: "Awaiting feedback", resolutionAdmin: "AdminY", resolutionStatus: "En Progreso", resolutionTimeDays: null },
  ...
  { id: "TASK-004", name: "User Testing Session 1", status: "Missing Estimated Dates", assignee: "Alice", taskReference: "T004", delayDays: 5, comments: "Resource unavailable", resolutionAdmin: "AdminX", resolutionStatus: "Bloqueado", resolutionTimeDays: null },
  ...
  { id: "TASK-006", name: "Critical Bug Fixing", status: "Pending to Invoice Out of Time", assignee: "Eve", taskReference: "T006BUG", comments: "High priority bug", resolutionAdmin: "AdminY", resolutionStatus: "En Progreso", resolutionTimeDays: null },
  ...
  { id: "TASK-010", name: "Marketing Campaign Launch", status: "Missing Estimated Dates", assignee: "Flora", taskReference: "T010MARKET", comments: "Campaign is live", resolutionAdmin: "AdminZ", resolutionStatus: "En Progreso", resolutionTimeDays: null },
